...
public class MsalException {
    ...
    private String[] mScopes = {"Files.ReadWrite.AppFolder","Files.ReadWrite.All","User.Read","email","Sites.ReadWrite.All"};

    private void AuthenticationHelper(Context ctx, final IAuthenticationHelperCreatedListener listener) {
    ...
    public void acquireTokenInteractively(Activity activity, BiometricPrompt.AuthenticationCallback callback) {
        mPCA.signIn(activity, null, mScopes, (AuthenticationCallback) callback);
    }

    public void acquireTokenSilently(BiometricPrompt.AuthenticationCallback callback) {
